...
{
    [AuthRequired]
    public abstract class RicControllerBase : Controller
    {
        protected readonly IRicService RicService;
        protected readonly ILogger Logger;
        protected readonly IWebHostEnvironment Env;

        protected RicControllerBase(IRicService ricService, ILogger logger, IWebHostEnvironment env)
        {
